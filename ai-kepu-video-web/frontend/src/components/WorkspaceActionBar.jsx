...
export function WorkspaceActionBar({
  ...
  return <footer className="workspace-actionbar">
    ...
    <div>
      ...
      {waitingForConfirmation && !voiceReady ? <Tooltip label="生成配音前必须先确认全片音色" placement="top"><button type="button" className="button button-primary" onClick={onConfirmVoice}><Volume2 size={16} />先确认全片音色</button></Tooltip> : null}
