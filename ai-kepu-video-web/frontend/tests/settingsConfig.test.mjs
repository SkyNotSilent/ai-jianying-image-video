...
test('normalizes prompt concurrency to four by default and clamps runtime concurrency', () => {
  ...
  assert.equal(normalizeConfig({ generation: { image_concurrency: 12 } }).generation.image_concurrency, 8)
  assert.equal(normalizeConfig(null).generation.image_concurrency, 8)
