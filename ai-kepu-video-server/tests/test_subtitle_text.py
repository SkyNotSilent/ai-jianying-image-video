...
def test_subtitle_normalization_keeps_balanced_quotes():
    ...
    assert normalize_subtitle_text(text) == '而是问“如果我连续做三年它会把我带到哪里”'
...
def test_subtitle_normalization_preserves_book_title_marks():
    assert normalize_subtitle_text('推荐《小岛经济学》，真的很好。') == '推荐《小岛经济学》真的很好'
